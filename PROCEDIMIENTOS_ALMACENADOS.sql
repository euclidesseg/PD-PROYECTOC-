...
CREATE PROC MODIDIFCAR_PROVEEDOR
@DNI_PROVEEDOR INT,
@NOM_PROVEEDOR VARCHAR(50),
@DIR_PROVEEDOR VARCHAR(50),
@TEL_PROVEEDOR INT
...
UPDATE  PROVEEDOR SET NOM_PROVEEDOR = NOM_PROVEEDOR, DIR_PROVEEDOR = DIR_PROVEEDOR, 
TEL_PROVEEDOR = @TEL_PROVEEDOR
WHERE DNI_PROVEEDOR = @DNI_PROVEEDOR
-----------------------------------------------------------------
...
@TEL_CLIENTE INT
AS
UPDATE CLIENTE SET NOM_CLIENTE = @NOM_CLIENTE, DIR_CLIENTE = @DIR_CLIENTE, TEL_CLIENTE =  DIR_CLIENTE
...
@DNI_PROVEEDOR INT
AS
UPDATE PRODUCTO SET NOM_PRODUCTO = @NOM_PROCUCTO, FECHA_INGRESO = @FECHA_INGRESO, CANTIDAD = @CANTIDAD,
PRECIO_COMPRA = PRECIO_COMPRA, PRECIO_VENTA = @PRECIO_VENTA, DNI_PROVEEDOR = @DNI_PROVEEDOR
WHERE REF_PRODUCTO = @REF_PRODUCTO


CREATE PROC MODIFICAR_VENTA
@NUM_VENTA INT,
@REF_PRODUCTO1 INT,
@MEDIO_PAGO VARCHAR(30)
AS
UPDATE VENTA SET REF_PRODUCTO1 = @REF_PRODUCTO1, MEDIO_PAGO = @MEDIO_PAGO
